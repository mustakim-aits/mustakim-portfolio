...
export function CircularCarousel({
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex flex-col items-center justify-center gap-6 outline-none pt-2",
        className,
      )}
    >
      {/* Circular track */}
      <div className="relative h-[280px] w-full max-w-lg mt-8">
      ...
      {activeItem && (
        <motion.div
          ...
          className="absolute inset-0 flex flex-col items-center justify-center pointer-events-none pb-12"
        >
